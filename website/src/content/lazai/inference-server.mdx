...
Follow the deployment guide in our [inference server repository](https://github.com/limike954/trajectory-data-00014) for detailed instructions on deploying your server to Phala TEE Cloud.
