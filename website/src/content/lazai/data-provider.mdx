...
```shell
cargo add alith --git https://github.com/limike954/trajectory-data-00014 --features "lazai,wallet,crypto,ipfs"
```
...
A simple data contribution UI template can be found [here](https://github.com/limike954/trajectory-data-00014/tree/main/apps/dat).
