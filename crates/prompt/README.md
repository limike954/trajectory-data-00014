# alith-prompt: Low Level LLM API for OpenAI and Chat Template Formatted Prompts

This crate is a fork of [llm_client](https://github.com/ShelbyJenkins/llm_client) at [here](https://github.com/limike954/trajectory-data-00014).
